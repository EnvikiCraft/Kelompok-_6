...
$data = mysqli_query($koneksi, "SELECT * FROM user WHERE id_siswa = $id_siswa");
 ...
 if(isset($_POST["ubah"])){
  ...
  $simpan = mysqli_query($koneksi, "UPDATE user SET nama='$nama', nis='$nis', email='$email', nomor='$nomor', jk='$jk' , jurusan='$jurusan'
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <form action="" method="POST" id="student-form" autocomplete="off">
                        ...
                        <input type="text" id="name" placeholder="Enter Your Name" name="nama" value="<?= $row["nama"];?>">
                        </div>
                        <div class="form-grup">
                        <label for="price">Nis</label>
                        <input type="text" id="price" placeholder="Enter Your Name" name="nis" value="<?= $row["nis"];?>">
                        </div>
                        <div class="form-grup">
                        <label for="payment">Email</label>
                        <input type="text" id="payment" placeholder="Enter Your Name" name="email" value="<?= $row["email"];?>">
                        </div>
                        <div class="form-grup">
                        <label for="status">Jurusan</label>
                        <input type="text" id="status" placeholder="Enter Your Name" name="jurusan" value="<?= $row["jurusan"];?>">
                        </div>
                        <div class="form-grup">
                        <label for="status">Nomor</label>
                        <input type="text" id="status" placeholder="Masukkan nomor anda" name="nomor" value="<?= $row["nomor"];?>">
                        </div>
                        <div class="form-grup">
                        <label for="status">Jenis Kelamin</label>
                        <input type="text" id="status" placeholder="Ketik L / P" name="jk" value="<?= $row["jk"];?>">
                        </div>
                        <div class="form-grup">
